...
let settings = {
    ...
    pages: [
        ...
        { image: './image/Birthday!/photo1.jpg', content: 'Dear Madamji, you bring so much joy and happiness! 💕' },
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'HAPPY|BIRTHDAY|MY|CUTE|LITTLE|MADAMJII|❤';
